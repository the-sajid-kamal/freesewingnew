<p align='center'><a
  href="https://www.npmjs.com/package/@freesewing/plugin-escape-text"
  title="@freesewing/plugin-escape-text on NPM"
  ><img src="https://img.shields.io/npm/v/@freesewing/plugin-escape-text.svg"
  alt="@freesewing/plugin-escape-text on NPM"/>
  </a><a
  href="https://opensource.org/licenses/MIT"
  title="License: MIT"
  ><img src="https://img.shields.io/npm/l/@freesewing/plugin-escape-text.svg?label=License"
  alt="License: MIT"/>
  </a><a
  href="#contributors-"
...
# @freesewing/plugin-escape-text

A FreeSewing plugin to escape user-provided text in SVG output
...
This folder holds: @freesewing/plugin-escape-text
