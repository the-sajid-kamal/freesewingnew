...
function draftCathrinPanel5({ macro, sa, points, paths, Point, store, Path, complete, part }) {
  ...
  // Waist line
  if (complete)
    paths.panel5Waist = new Path()
      .move(points.waistGap4Right)
      .line(points.waistGap5Left)
