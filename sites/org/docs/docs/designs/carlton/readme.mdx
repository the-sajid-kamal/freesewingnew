...
Carlton has a lot of pieces! These lengths are estimates, you may need more or
...
Remember that this pattern is intended to be a winter coat so you need to
...
Lightweight **Cottons** such as **Cotton Silesia**, **Cotton Lawn** or **Glazed
...
As per usual with Linings it is really down to your prefered lining materials
...
We recommend **Hair canvases**. You may be tempted to use modern interfacing
but hair canvases will provide the best results. You will want a combination of
...
You can use fusible or non-fusible facings but you may find that you still need
...
Certain hair canvases, such as **Horsehair canvas** can have stiff hairs that
...
Certain parts have to be drafted off of the existing parts. How to draft these
