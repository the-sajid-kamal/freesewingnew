...
- (optional) Baste the seam, taking care to secure the portion near the crotch, as it has a tendency to slip and cause a hole in the next step if not well secured.
...
- If sewing swim fabric, sew the fabric and the zipper tape together with a straight stitch down each side. This is both to hold things together, and to provide a second, safety line of stitching for the zipper. For less tricky fabrics, this step is optional.
...
- Repeat for the other side. This time, when you reach the bottom, turn the fabric 90 degrees and sew across the bottom until you meet the first line of stitching, securing the bottom of the zipper and zipper guard.

### Step 7a: (Optional) Ribbed cuffs

The ribbed cuff pieces can be added to the sleeves and legs in a manner similar to that used to attach the neckband to the neck hole.
