...
When you have a pattern piece that is symmetric, the instructions might tell you that it is to be cut <dfn>on the fold</dfn>.

This means that only half the pattern piece is printed, and you should cut it out by folding your fabric, and
aligning the line that is <dfn>on the fold</dfn> with the fold line indicated on the pattern.
