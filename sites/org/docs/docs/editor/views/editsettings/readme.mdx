...
The _editSettings_ view allows you to manually tweak all of the inputs of your pattern, accept the design.
That includes:
...
Changes you make here are not immediate. Instead, once you introduce a change,
